...
=======
sbit buzzer=P2^4;
code unsigned int tune[]={0,64260,64400,64524,64580,64684,64770,64800,64898,64968,65030,65058,65110,65157,65178,65217};//存放各个音调所对应的定时时长 
code unsigned int song2_tune[]={8,9,10,8,8,9,10,8,10,11,12,10,11,12,12,13,12,11,10,8,12,13,12,11,10,8,9,5,8,0,9,5,8,0};
code unsigned int song2_time[]={3,3,3,3,3,3,3,3,3,3,6,3,3,6,3,3,3,3,6,6,3,3,3,3,6,6,6,6,6,6,6,6,6,0};//歌曲2：两只老虎
code unsigned int song3_tune[]={6,7,8,12,11,0,5,6,7,11,10,0,10,10,13,12,11,9,0,7,7,8,9,11,10,0};
	code unsigned int song3_time[]={3,3,6,6,6,6,3,3,6,6,6,6,3,3,6,6,6,6,3,3,6,3,6,6,6,0};//歌曲3：贝加尔湖畔
code unsigned int song4_tune[]={6,7,8,7,8,10,7,0,3,6,5,6,8,5,0,3,4,3,4,8,3,0,8,7,4,4,7,7,0};
	code unsigned int song4_time[]={3,6,9,3,6,6,6,6,6,9,3,6,6,6,6,6,9,3,3,6,6,6,6,9,3,6,6,6,0};//歌曲4：天空之城

//tune中存放音乐音调，time中存放节拍
>>>>>>> bff2cfa (绾㈠閬ユ帶)
